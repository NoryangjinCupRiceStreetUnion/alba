    ...
    <div className="relative">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 flex flex-col gap-4">
          ...
          {/* Description Card */}
          <div className="mt-4 rounded-xs border border-border/50 bg-card p-6 text-left">
            <h3 className="text-lg font-bold mb-4">상세 물건 설명</h3>
            <p className="text-sm text-muted-foreground leading-relaxed whitespace-pre-wrap">
              {item.description}
            </p>
            <div className="mt-6 flex items-center gap-2 rounded-xs bg-indigo-500/5 border border-indigo-500/10 p-3 text-xs text-indigo-600 dark:text-indigo-400">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          {/* Header Info Card */}
          <div className="rounded-sm border border-border/50 bg-card p-6 text-left shadow-sm">
            <div className="flex justify-between items-start gap-4">
              ...
              <div className="flex gap-1">
                ...
                <button className="p-2 rounded-xs border border-border/60 hover:bg-accent text-muted-foreground hover:text-foreground">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 text-xs">
              <div className="bg-accent/40 border border-border/40 rounded-xs p-2.5">
              ...
              <div className="col-span-2 bg-accent/40 border border-border/40 rounded-xs p-2.5">
          ...
          <div className="rounded-3xl border border-border/50 bg-card p-5 text-left shadow-sm flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-xs bg-indigo-500/10 font-black text-indigo-500 border border-indigo-500/20">
          ...
          <div className="rounded-3xl border border-indigo-500/20 bg-indigo-500/5 p-6 text-left shadow-md relative overflow-hidden">
            ...
            <form onSubmit={handleBooking} className="flex flex-col gap-4 relative z-10">
              <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    max={availableUntil}
                    className="h-10 rounded-xs border border-border bg-background px-3 text-xs focus:border-indigo-600 focus:outline-none"
                  />
                </div>
                <div className="flex flex-col gap-1.5">
              ...
              {rentalDays > 0 ? (
                <div className="rounded-xs bg-card border border-border/80 p-4 mt-2 space-y-2 animate-in fade-in slide-in-from-bottom-2 duration-200">
                ...
                <div className="rounded-xs border border-dashed border-border/80 p-4 text-center text-xs text-muted-foreground bg-background/40">
              ...
              <Button
                ...
                className="mt-4 h-12 w-full rounded-xs bg-indigo-600 hover:bg-indigo-500 text-white font-bold tracking-wide shadow-md shadow-indigo-600/15 disabled:opacity-50"
              >
                대여 예약 제안하기
              </Button>
            </form>
      ...
      {isBooked && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="relative w-full max-w-md rounded-3xl border border-border/80 bg-card p-6 shadow-2xl text-center animate-in scale-in-95 duration-200">
            ...
            {/* Receipt Box */}
            <div className="mt-5 rounded-xs bg-accent/40 border border-border/40 p-4 text-left space-y-2 text-xs">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                ...
                className="h-10 rounded-xs border border-border text-xs font-semibold hover:bg-accent transition-colors"
              >
                닫기
              </button>
              <button
                ...
                className="h-10 w-full rounded-xs bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold shadow-md shadow-indigo-600/10"
              >
                채팅방으로 이동
              </button>
            </div>
